                        ...
                        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="class_id" class="form-control" id="class_id"
                        ...
                        <div class="modal-body">
                            <form action="{{ route('students.update', $row->id) }}" method="POST"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <label for="edit_class_id" class="form-label">ID Kelas</label>
                                        <input type="number" name="class_id" class="form-control" id="edit_class_id"
                                               value="{{ $row->class_id }}">
                                    </div>
                                </div>
                                <div class="mb-3">
