...
@section('content')
    ...
    <section class="about-section">
        <div class="background-container">
            <img src="logo-sekolah.png" alt="SMA Sanjaya XIV Nanggulan" class="background-image img-fluid">
            <div class="overlay"></div>
            <div class="content" style="text-align: left;">
                <h1 class="title">SELAMAT DATANG DI SMA SANJAYA XIV<br>NANGGULAN</h1>
                <p class="description">
